...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://jacobdevereaux.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post",
    };
  ...
  componentDidMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://jacobdevereaux.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch",
      });
    }
  }
  ...
  handleSubmit(event) {
    axios({
      ...
      .then((response) => {
        ...
        if (this.props.editMode) {
          this.props.handleUpdateFormSubmisison(response.date.portfolio_blog);
        } else {
